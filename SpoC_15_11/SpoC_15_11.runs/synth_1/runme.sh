...
HD_PWD='C:/Users/HP/SpoC_15_11/SpoC_15_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LWC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LWC.tcl
